...
export const SITES: SiteConfig[] = [
  ...
  },
  {
    ...
    logo_emoji: "📦", points_type: "Amazonポイント", is_active: true, sort_order: 4,
  ...
  },
  {
    ...
    logo_emoji: "🗾", points_type: "選択制", is_active: true, sort_order: 5,
    affiliate_template: "https://px.a8.net/svt/ejp?a8mat={AFF_ID}&a8ejpredirect={PRODUCT_URL}",
  ...
  {
    id: "dshopping", display_name: "dショッピングふるさと納税", color: "#E53935", text_color: "#FFFFFF",
    logo_emoji: "📱", points_type: "dポイント", is_active: true, sort_order: 8,
    affiliate_template: "{PRODUCT_URL}",
    env_vars: {},
  },
  {
    id: "honpo", display_name: "ふるさと本舗", color: "#795548", text_color: "#FFFFFF",
    logo_emoji: "🏪", points_type: "選択制", is_active: true, sort_order: 9,
    affiliate_template: "https://px.a8.net/svt/ejp?a8mat={AFF_ID}&a8ejpredirect={PRODUCT_URL}",
    env_vars: { AFF_ID: "A8_HONPO_ID" },
  },
  {
    id: "ana", display_name: "ANAふるさと納税", color: "#0066CC", text_color: "#FFFFFF",
    logo_emoji: "✈️", points_type: "ANAマイル", is_active: true, sort_order: 10,
  ...
  },
  {
    ...
    logo_emoji: "✈️", points_type: "JALマイル", is_active: true, sort_order: 11,
    affiliate_template: "{PRODUCT_URL}?aff={AFF_ID}",
    env_vars: { AFF_ID: "JAL_AFF_ID" },
  },
  {
    id: "mynavi", display_name: "マイナビふるさと納税", color: "#E91E63", text_color: "#FFFFFF",
    logo_emoji: "💼", points_type: "マイナビポイント", is_active: false, sort_order: 12,
    affiliate_template: "https://px.a8.net/svt/ejp?a8mat={AFF_ID}&a8ejpredirect={PRODUCT_URL}",
    env_vars: { AFF_ID: "A8_MYNAVI_ID" },
  },
  {
    id: "furu_premium", display_name: "ふるさとプレミアム", color: "#7B1FA2", text_color: "#FFFFFF",
    logo_emoji: "✨", points_type: "選択制", is_active: true, sort_order: 13,
    affiliate_template: "{PRODUCT_URL}",
    env_vars: {},
  },
  {
  ...
  },
  {
    ...
    logo_emoji: "🏬", points_type: "三越伊勢丹ポイント", is_active: true, sort_order: 15,
    affiliate_template: "{PRODUCT_URL}?aff={AFF_ID}",
    env_vars: { AFF_ID: "MITSUKOSHI_AFF_ID" },
  },
  {
    id: "aupay", display_name: "au PAYふるさと納税", color: "#FF6600", text_color: "#FFFFFF",
    logo_emoji: "📱", points_type: "Pontaポイント", is_active: true, sort_order: 16,
    affiliate_template: "{PRODUCT_URL}",
    env_vars: {},
  },
  {
    id: "saison", display_name: "セゾンのふるさと納税", color: "#003F8A", text_color: "#FFFFFF",
    logo_emoji: "💳", points_type: "永久不滅ポイント", is_active: true, sort_order: 17,
    affiliate_template: "https://ck.jp.ap.valuecommerce.com/servlet/referral?sid={SID}&pid={PID}&vc_url={PRODUCT_URL}",
    env_vars: { SID: "VC_SAISON_SID", PID: "VC_SAISON_PID" },
  },
  {
    id: "jre_mall", display_name: "JRE MALL", color: "#009933", text_color: "#FFFFFF",
    logo_emoji: "🚃", points_type: "JREポイント", is_active: true, sort_order: 18,
    affiliate_template: "{PRODUCT_URL}?aff={AFF_ID}",
    env_vars: { AFF_ID: "JRE_AFF_ID" },
  },
  {
    id: "palette", display_name: "東急ふるさとパレット", color: "#CF2020", text_color: "#FFFFFF",
    logo_emoji: "🚃", points_type: "TOKYU POINT", is_active: true, sort_order: 19,
    affiliate_template: "{PRODUCT_URL}",
    env_vars: {},
  },
  {
  ...
  },
  {
    ...
    logo_emoji: "🚃", points_type: "TOKYU POINT", is_active: false, sort_order: 21,
    affiliate_template: "{PRODUCT_URL}?aff={AFF_ID}",
    env_vars: { AFF_ID: "TOKYU_AFF_ID" },
  },
  {
    id: "qoo10", display_name: "Qoo10", color: "#FF4081", text_color: "#FFFFFF",
    logo_emoji: "🛒", points_type: "Qoo10ポイント", is_active: true, sort_order: 22,
    affiliate_template: "https://px.a8.net/svt/ejp?a8mat={AFF_ID}&a8ejpredirect={PRODUCT_URL}",
    env_vars: { AFF_ID: "A8_QOO10_ID" },
  },
  {
    id: "montbell", display_name: "モンベル", color: "#1565C0", text_color: "#FFFFFF",
    logo_emoji: "⛺", points_type: "モンベルポイント", is_active: true, sort_order: 23,
    affiliate_template: "{PRODUCT_URL}?aff={AFF_ID}",
    env_vars: { AFF_ID: "MONTBELL_AFF_ID" },
  },
  {
    id: "yell", display_name: "ふるさとエール", color: "#4CAF50", text_color: "#FFFFFF",
    logo_emoji: "📣", points_type: "選択制", is_active: true, sort_order: 24,
    affiliate_template: "{PRODUCT_URL}",
    env_vars: {},
  },
  {
    id: "furopo", display_name: "ふるぽ", color: "#00897B", text_color: "#FFFFFF",
    logo_emoji: "🎁", points_type: "選択制", is_active: true, sort_order: 25,
    affiliate_template: "{PRODUCT_URL}",
    env_vars: {},
  },
  {
    id: "tabechoku", display_name: "食べチョク", color: "#43A047", text_color: "#FFFFFF",
    logo_emoji: "🥗", points_type: "選択制", is_active: true, sort_order: 26,
    affiliate_template: "{PRODUCT_URL}",
    env_vars: {},
  },
  {
    id: "maifuru", display_name: "まいふる", color: "#E91E63", text_color: "#FFFFFF",
    logo_emoji: "🏠", points_type: "WAONポイント", is_active: true, sort_order: 27,
    affiliate_template: "{PRODUCT_URL}",
    env_vars: {},
  },
  {
    id: "gurune", display_name: "ぐるなびふるさと納税", color: "#D32F2F", text_color: "#FFFFFF",
    logo_emoji: "🍽️", points_type: "選択制", is_active: false, sort_order: 28,
    affiliate_template: "{PRODUCT_URL}",
    env_vars: {},
  },
  {
    id: "nippon", display_name: "ふるさと納税ニッポン！", color: "#1565C0", text_color: "#FFFFFF",
    logo_emoji: "🗾", points_type: "選択制", is_active: true, sort_order: 29,
    affiliate_template: "{PRODUCT_URL}",
    env_vars: {},
  },
  {
    id: "gurusuguri", display_name: "ぐるすぐり", color: "#E53935", text_color: "#FFFFFF",
    logo_emoji: "🍽️", points_type: "選択制", is_active: false, sort_order: 31,
    affiliate_template: "{PRODUCT_URL}",
    env_vars: {},
  },
];
